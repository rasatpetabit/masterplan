...
- files: README.md, skills/masterplan/SKILL.md, docs/verbs.md, test/docs-contract.test.mjs, .claude-plugin/plugin.json, .claude-plugin/marketplace.json, .codex-plugin/plugin.json, package.json
