...
//                                                   chain then panel, primary excluded, or the
//                                                   config override; the shell dispatches
//                                                   mp-fallback-reviewer per entry, in order, and
...
//   - unset (default)                   → adversary class chain, then panel members,
//                                          primary excluded, de-duplicated (routing policy)
...
function finishReviewFallback(repoRoot) {
  ...
  const { reviewers, reason } = adversaryFallbackReviewers();
