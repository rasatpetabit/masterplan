// lib/fabric-idempotency.mjs — pure handoff-idempotency key module (spec §5.5).
//
// STATUS (fabric-v1): correctness core for the masterplan↔fabric handoff seam.
// (Renamed from the retired dispatch-era module; key scheme re-versioned —
// no in-flight waves existed at the cutover, so no live handoff keys moved.)
...
export const IDEMPOTENCY_VERSION = 'fabric-idem-v1';
 ...
 * @returns {string} 'fabric-idem-v1:<run>:<task>:<spec_hash>:<fingerprint>'
 */
