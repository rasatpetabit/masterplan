...
//   6. wave_recorded event, then state commit in MAIN — pathspec-scoped to the bundle dir
...
export function recordWaveResult({ statePath, result = null, self, now, worktree } = {}) {
  ...
  // 6. Event (before the state commit so it lands IN the state commit), then the MAIN
