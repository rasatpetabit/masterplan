...
export function dispatchPlanFanout({
  ...
  const descriptors = subsystems.map((sub) => buildPlanWorkItem(sub, { roots, specPath: spec, repoRoot: MAIN }));
 ...
 */
export function buildPlanWorkItem(s, { roots, specPath, repoRoot }) {
  const brief = [
