// lib/dispatch/dispatch-digest.mjs — dispatch surface: work-item prep, digest
// translation, dispatchTask entry points, and cross-review bridges.
//
// Extracted from adsp-adapter.mjs (Task 2 of adsp-adapter decomposition).
// adsp-adapter.mjs re-exports this module for backward compatibility.
//
// Owns:
...
// dispatcher, lib/dispatch-wave.mjs — ONE mapping, no drift)
// ---------------------------------------------------------------------------
 ...
 * broker returns (its steps 5-8), exported so the wave-level dispatcher
 * maps each per-descriptor result identically:
 *
