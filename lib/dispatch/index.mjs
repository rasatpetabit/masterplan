...
// more than masterplan (the /srv/dev/agent-dispatch policy repo is the policy side; this
...
//   host.mjs    — detectHost / suppressRescue / normalizeResumeHint (Codex-host
//                 dual-targeting: never dispatch Codex from Codex)
...
export { detectHost, suppressRescue, normalizeResumeHint, CODEX_ENTRYPOINT } from './host.mjs';
