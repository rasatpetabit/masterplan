// lib/dispatch/index.mjs — the dispatch-decision module: every "where/how does this work run"
// decision behind ONE import surface.
//
// The routing source of truth is the repo-local workflow routing policy
// (policy/workflow-map.json, see routing-policy.mjs); this package is the
// mechanism side. The boundary rule: DECISION LOGIC IN, STATE MACHINE OUT.
...
//
// Submodules:
//   routing.mjs — resolveImplementerBackend (the {kind:'agent'|'qctl'} tagged union); the
//                 pre-resolved codex/inline/ask eligibility brain was deleted (C6) — routing now
//                 resolves through the governed routing-policy resolver (routing-policy.mjs)
...
export { resolveImplementerBackend } from './routing.mjs';
