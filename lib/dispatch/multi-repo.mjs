...
// descriptor to `repo = worktree` makes skynet_edit fail with "file not found"
// for every sibling path — and new files also fail because create_files is never set.
//
