// lib/dispatch/routing.mjs — Codex eligibility as a PURE function (build step 1).
//
// Ports v7's eligibility checklist + precedence (v7 parts/step-c-dispatch.md, deleted at the cutover; see tag v8.1.0-pre-cruft-removal) into
...
// the dispatch-wave seam, commit 561f348 — the descriptor never restates fields the dispatch
