...
// purely informational: masterplan's review is cross-vendor (the agent-dispatch adversary lane —
// no Codex), so codex auth never gates a masterplan run. The check only flags a stale Codex login
