// lib/codex-host.mjs — Codex-host dual-targeting, minimized (build step 1; Resolved #6).
//
// detectHost / suppressRescue / normalizeResumeHint. The recursive-dispatch suppression and
// the `$masterplan` shell-trap normalization are CORRECTNESS invariants carried from v7
// (v7 parts/codex-host.md — attic'd at the v8.2.0 cutover to docs/attic/v7-codex-hedge/). The bespoke codex_host_perf_guard is dropped in favor of the
...
// While Codex-hosted, never dispatch the codex:codex-rescue companion (the dispatch would be
// recursive — Codex calling Codex). Per-invocation only; never mutate persisted
// codex.routing / codex.review here (that stays a Claude-Code-run concern, handled by the shell).
export function suppressRescue(host = {}) {
  return host.isCodex === true;
}
