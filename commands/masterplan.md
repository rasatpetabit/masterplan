...
guard — once per run, zero candidates → silent), the verified-at-SHA skip, retro write-if-absent gating, the durable sha-keyed codex-review re-entry guard
