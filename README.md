...
Current release: **v7.2.2** · **License:** MIT · **Works with:** Claude Code, Codex CLI · See [CHANGELOG.md](./CHANGELOG.md)
...
*   `/masterplan doctor [--fix]`
    *   **Phase:** Diagnostics
    *   **What it does:** Runs 52 proactive lint checks across all plan bundles to catch state drift. `--fix` resolves repairable issues.
*   `/masterplan status`
    *   **Phase:** Diagnostics
