...
export const REGISTRY = [
  ...
  },
  {
    id: 'format_pin',
    kind: 'state',
    describe: 'the goals format pin (legacy vs schema_backed) changes the canonical goals hash byte-for-byte — what checkpoints, finish and split-brain bind',
  ...
  },
  {
    id: 'schema_capture',
    kind: 'state',
    describe: 'a captured vs uncaptured bundle changes endInterview convergence policy on an identical ledger (schema-backed two conditions vs legacy floors)',
    values: ['captured', 'uncaptured'],
