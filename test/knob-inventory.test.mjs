...
const CLOSED_SEAM_ALLOWLIST = [
  ...
  { at: 'bin/masterplan.mjs:1376', why: 'shouldSuppressWorkflow(flags = {}, env = process.env): default-param env injection; callers pass readEnvAll() (the seam proxy) and the only read is env.PI_CODING_AGENT' },
